...
const (
	RegistrationService_Register_FullMethodName      = "/pgswarm.v1.RegistrationService/Register"
	RegistrationService_CheckApproval_FullMethodName = "/pgswarm.v1.RegistrationService/CheckApproval"
)
...
func (c *registrationServiceClient) CheckApproval(ctx context.Context, in *CheckApprovalRequest, opts ...grpc.CallOption) (*CheckApprovalResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CheckApprovalResponse)
	err := c.cc.Invoke(ctx, RegistrationService_CheckApproval_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRegistrationServiceServer) CheckApproval(context.Context, *CheckApprovalRequest) (*CheckApprovalResponse, error) {
...
func _RegistrationService_CheckApproval_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CheckApprovalRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RegistrationServiceServer).CheckApproval(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RegistrationService_CheckApproval_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegistrationServiceServer).CheckApproval(ctx, req.(*CheckApprovalRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RegistrationService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "pgswarm.v1.RegistrationService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RegistrationService_CheckApproval_Handler,
		},
	},
