...
export const pgParamClassifications = [
  // full_restart: replication breaks on mismatch
  { name: 'wal_level', restart_mode: 'full_restart', description: 'WAL detail level — mismatch between primary and replica breaks streaming replication', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },

  // sequential: postmaster context, requires process restart
  { name: 'shared_buffers', restart_mode: 'sequential', description: 'Shared memory buffer pool size', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_connections', restart_mode: 'sequential', description: 'Maximum number of concurrent connections', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'superuser_reserved_connections', restart_mode: 'sequential', description: 'Connections reserved for superusers', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'huge_pages', restart_mode: 'sequential', description: 'Use of huge pages for shared memory', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_wal_senders', restart_mode: 'sequential', description: 'Maximum number of WAL sender processes', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_replication_slots', restart_mode: 'sequential', description: 'Maximum number of replication slots', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_worker_processes', restart_mode: 'sequential', description: 'Maximum number of background worker processes', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_parallel_workers', restart_mode: 'sequential', description: 'Maximum number of parallel query workers', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'shared_preload_libraries', restart_mode: 'sequential', description: 'Libraries to preload at server start', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_locks_per_transaction', restart_mode: 'sequential', description: 'Maximum number of locks per transaction', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_prepared_transactions', restart_mode: 'sequential', description: 'Maximum number of simultaneously prepared transactions', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'wal_log_hints', restart_mode: 'sequential', description: 'Writes full-page images of modified pages to WAL', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'archive_mode', restart_mode: 'sequential', description: 'Enables WAL archiving', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'track_commit_timestamp', restart_mode: 'sequential', description: 'Collects transaction commit timestamps', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'ssl', restart_mode: 'sequential', description: 'Enables SSL connections', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'hot_standby', restart_mode: 'sequential', description: 'Allows queries on standby servers', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_files_per_process', restart_mode: 'sequential', description: 'Maximum number of open files per server process', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'bonjour', restart_mode: 'sequential', description: 'Enables Bonjour advertising', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'autovacuum_max_workers', restart_mode: 'sequential', description: 'Maximum number of autovacuum worker processes', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'pg_stat_statements.max', restart_mode: 'sequential', description: 'Maximum number of tracked statements', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },

  // reload: sighup/user/superuser context, takes effect on pg_reload_conf()
  // Memory
  { name: 'work_mem', restart_mode: 'reload', description: 'Memory for sort operations and hash tables', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'maintenance_work_mem', restart_mode: 'reload', description: 'Memory for maintenance operations (VACUUM, CREATE INDEX)', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'effective_cache_size', restart_mode: 'reload', description: 'Planner estimate of effective disk cache size', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'temp_buffers', restart_mode: 'reload', description: 'Maximum number of temporary buffers per session', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  // WAL & Checkpoints
  { name: 'checkpoint_completion_target', restart_mode: 'reload', description: 'Fraction of checkpoint interval for spreading writes', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'checkpoint_timeout', restart_mode: 'reload', description: 'Maximum time between automatic WAL checkpoints', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'checkpoint_warning', restart_mode: 'reload', description: 'Warn if checkpoints happen more frequently than this', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_wal_size', restart_mode: 'reload', description: 'Maximum WAL size between checkpoints', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'min_wal_size', restart_mode: 'reload', description: 'Minimum WAL size to retain', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'archive_command', restart_mode: 'reload', description: 'Shell command to execute for WAL archiving', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'archive_timeout', restart_mode: 'reload', description: 'Force WAL switch after this many seconds of inactivity', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'wal_keep_size', restart_mode: 'reload', description: 'Minimum WAL size to retain in pg_wal', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  // Replication
  { name: 'max_standby_streaming_delay', restart_mode: 'reload', description: 'Maximum delay before canceling queries on standby', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_standby_archive_delay', restart_mode: 'reload', description: 'Maximum delay before canceling queries during recovery', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'hot_standby_feedback', restart_mode: 'reload', description: 'Send feedback to primary about queries on standby', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_slot_wal_keep_size', restart_mode: 'reload', description: 'Maximum WAL size retained by replication slots', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'synchronous_commit', restart_mode: 'reload', description: 'Sets the current synchronous commit level', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'synchronous_standby_names', restart_mode: 'reload', description: 'Standby servers for synchronous replication', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  // Query Planner
  { name: 'random_page_cost', restart_mode: 'reload', description: 'Planner cost estimate for a random disk page fetch', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'seq_page_cost', restart_mode: 'reload', description: 'Planner cost estimate for a sequential disk page fetch', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'cpu_tuple_cost', restart_mode: 'reload', description: 'Planner cost estimate for processing each row', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'cpu_index_tuple_cost', restart_mode: 'reload', description: 'Planner cost estimate for processing each index entry', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'cpu_operator_cost', restart_mode: 'reload', description: 'Planner cost estimate for processing each operator', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'effective_io_concurrency', restart_mode: 'reload', description: 'Number of simultaneous I/O operations for the planner', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'default_statistics_target', restart_mode: 'reload', description: 'Default statistics target for table columns', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'jit', restart_mode: 'reload', description: 'Allow JIT compilation of queries', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'jit_above_cost', restart_mode: 'reload', description: 'Query cost above which JIT is activated', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'jit_inline_above_cost', restart_mode: 'reload', description: 'Query cost above which JIT inlines functions', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'jit_optimize_above_cost', restart_mode: 'reload', description: 'Query cost above which JIT applies optimizations', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'enable_seqscan', restart_mode: 'reload', description: 'Enable sequential scan plan type', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'enable_indexscan', restart_mode: 'reload', description: 'Enable index scan plan type', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'enable_hashjoin', restart_mode: 'reload', description: 'Enable hash join plan type', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'enable_mergejoin', restart_mode: 'reload', description: 'Enable merge join plan type', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'enable_nestloop', restart_mode: 'reload', description: 'Enable nested-loop join plan type', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  // Logging
  { name: 'log_min_duration_statement', restart_mode: 'reload', description: 'Log statements running longer than this (ms)', pg_context: 'superuser', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_min_messages', restart_mode: 'reload', description: 'Minimum message severity to log', pg_context: 'superuser', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_min_error_statement', restart_mode: 'reload', description: 'Minimum error severity to log the statement', pg_context: 'superuser', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_statement', restart_mode: 'reload', description: 'Which SQL statements to log (none/ddl/mod/all)', pg_context: 'superuser', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_duration', restart_mode: 'reload', description: 'Log the duration of each completed statement', pg_context: 'superuser', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_connections', restart_mode: 'reload', description: 'Log each successful connection', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_disconnections', restart_mode: 'reload', description: 'Log end of each session', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_lock_waits', restart_mode: 'reload', description: 'Log long lock waits', pg_context: 'superuser', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_temp_files', restart_mode: 'reload', description: 'Log temporary file usage above this size (kB)', pg_context: 'superuser', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_checkpoints', restart_mode: 'reload', description: 'Log each checkpoint', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_autovacuum_min_duration', restart_mode: 'reload', description: 'Log autovacuum runs longer than this (ms)', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_line_prefix', restart_mode: 'reload', description: 'Printf-style format string for log line prefix', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'log_timezone', restart_mode: 'reload', description: 'Timezone used for timestamps in log messages', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  // Autovacuum
  { name: 'autovacuum', restart_mode: 'reload', description: 'Enable autovacuum subprocess', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'autovacuum_naptime', restart_mode: 'reload', description: 'Time between autovacuum runs', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'autovacuum_vacuum_threshold', restart_mode: 'reload', description: 'Minimum number of row updates before vacuum', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'autovacuum_vacuum_scale_factor', restart_mode: 'reload', description: 'Fraction of table size before vacuum', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'autovacuum_analyze_threshold', restart_mode: 'reload', description: 'Minimum number of row updates before analyze', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'autovacuum_analyze_scale_factor', restart_mode: 'reload', description: 'Fraction of table size before analyze', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'autovacuum_vacuum_cost_delay', restart_mode: 'reload', description: 'Vacuum cost delay for autovacuum (ms)', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'autovacuum_vacuum_cost_limit', restart_mode: 'reload', description: 'Vacuum cost limit for autovacuum', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  // Vacuum throttling
  { name: 'vacuum_cost_delay', restart_mode: 'reload', description: 'Vacuum cost delay for manual VACUUM (ms)', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'vacuum_cost_page_hit', restart_mode: 'reload', description: 'Vacuum cost for a page found in buffer cache', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'vacuum_cost_page_miss', restart_mode: 'reload', description: 'Vacuum cost for a page not in buffer cache', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'vacuum_cost_page_dirty', restart_mode: 'reload', description: 'Vacuum cost for dirtying a clean page', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'vacuum_cost_limit', restart_mode: 'reload', description: 'Total vacuum cost limit before napping', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  // Client defaults
  { name: 'statement_timeout', restart_mode: 'reload', description: 'Maximum allowed duration of any statement (ms)', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'idle_in_transaction_session_timeout', restart_mode: 'reload', description: 'Maximum idle time in transaction before termination', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'lock_timeout', restart_mode: 'reload', description: 'Maximum time to wait for a lock (ms)', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'search_path', restart_mode: 'reload', description: 'Schema search path', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'default_transaction_isolation', restart_mode: 'reload', description: 'Default transaction isolation level', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'timezone', restart_mode: 'reload', description: 'Timezone for displaying and interpreting timestamps', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'datestyle', restart_mode: 'reload', description: 'Display format for date and time values', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'client_min_messages', restart_mode: 'reload', description: 'Minimum message severity sent to client', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  // Statistics & monitoring
  { name: 'track_activities', restart_mode: 'reload', description: 'Collects information about executing commands', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'track_counts', restart_mode: 'reload', description: 'Collects statistics on database activity', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'track_io_timing', restart_mode: 'reload', description: 'Collects timing statistics for I/O operations', pg_context: 'superuser', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'track_functions', restart_mode: 'reload', description: 'Collects function-level statistics', pg_context: 'superuser', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'pg_stat_statements.track', restart_mode: 'reload', description: 'Which statements pg_stat_statements tracks', pg_context: 'superuser', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  // Connection & authentication
  { name: 'tcp_keepalives_idle', restart_mode: 'reload', description: 'Seconds of inactivity before sending a TCP keepalive', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'tcp_keepalives_interval', restart_mode: 'reload', description: 'Seconds between TCP keepalive retransmits', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'tcp_keepalives_count', restart_mode: 'reload', description: 'Maximum number of TCP keepalive retransmits', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'password_encryption', restart_mode: 'reload', description: 'Encryption method for stored passwords', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'authentication_timeout', restart_mode: 'reload', description: 'Maximum time to complete client authentication', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  // Miscellaneous
  { name: 'max_parallel_workers_per_gather', restart_mode: 'reload', description: 'Maximum parallel workers per Gather plan node', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'max_parallel_maintenance_workers', restart_mode: 'reload', description: 'Maximum parallel workers for maintenance operations', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'parallel_tuple_cost', restart_mode: 'reload', description: 'Planner cost of passing each tuple from worker to leader', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'parallel_setup_cost', restart_mode: 'reload', description: 'Planner cost of launching parallel workers', pg_context: 'user', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'recovery_target_timeline', restart_mode: 'reload', description: 'Target timeline for recovery', pg_context: 'postmaster', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
  { name: 'wal_receiver_timeout', restart_mode: 'reload', description: 'Maximum wait time for WAL receiver to receive data', pg_context: 'sighup', created_at: ago(86400 * 30), updated_at: ago(86400 * 30) },
